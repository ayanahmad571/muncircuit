        ...
        <div class="wrapper-page animated fadeInDown">
            <div class="panel panel-color panel-primary">
                <div class="panel-heading"> 
                   <h3 class="text-center m-t-10"> Sign In to <strong>Mun Circuit</strong> </h3>
                </div> 
...
?>                       
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <input <?php if(isset($_GET['notss'])){echo 'style="border:red 1px solid" ';} ?> name="lo_eml" class="form-control" type="email" placeholder="Email">
                        </div>
                    </div>
                    <div class="form-group ">
